...
import com.example.demoplayer.presentation.views.GridItemDecoration
import com.example.demoplayer.presentation.views.TouchImageView
                    ...
                    viewStates.collect { uiState ->
                        when (uiState) {
                            is GalleryViewModel.GalleryViewStates.SetImages -> {
                                ...
                                bind.include.tvSubtitle.text = "Page: $page, Images: ${adapter.itemCount}"
                            }
